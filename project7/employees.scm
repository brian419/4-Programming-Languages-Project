                    ...
                    (cond ((string=? action "count") ; eq ne gt ge lt le
                        (cond
                            ...
                            ((string=? (car (cdr args)) "ne")
                                ...
                                ;print the number of employees that have a salary not equal to the threshold
                                (let ((file (open-input-file filename)))
                                        (let loop ((threshold (car (cdr (cdr args)))) (count 0))
                                            (let ((line (read-line file)))
                                                (cond
                            ...
                            ((string=? (car (cdr args)) "gt")
                                ...
                                ;print the number of employees that have a salary greater than the threshold
                                (let ((file (open-input-file filename)))
                                        (let loop ((threshold (car (cdr (cdr args)))) (count 0))
                                            (let ((line (read-line file)))
                                                (cond
                            ...
                            ((string=? (car (cdr args)) "ge")
                                ...
                                ;print the number of employees that have a salary graeter than or equal to the threshold
                                (let ((file (open-input-file filename)))
                                        (let loop ((threshold (car (cdr (cdr args)))) (count 0))
                                            (let ((line (read-line file)))
                                                (cond
                                        ...
                                        (let loop ((threshold (car (cdr (cdr args)))) (total 0) (count 0))
                                            (let ((line (read-line file)))
                                                (cond
                                                    ((eof-object? line)
                                                        (close-input-port file)
                                                        (display "Average earnings of all employees not equal to the threshold: $")
                                                        (display (/ total count))                                                                                                                                                                                      
                                                        (newline)  
                                                        (newline)                                        
                                                    )
                                        ...
                                        (let loop ((threshold (car (cdr (cdr args)))) (total 0) (count 0))
                                            (let ((line (read-line file)))
                                                (cond
                                                    ((eof-object? line)
                                                        (close-input-port file)
                                                        (display "Average earnings of all employees greater than the threshold: $")
                                                        (display (/ total count))                                                                                                                                                                                      
                                                        (newline)  
                                                        (newline)                                        
                                                    )
                                        ...
                                        (let loop ((threshold (car (cdr (cdr args)))) (total 0) (count 0))
                                            (let ((line (read-line file)))
                                                (cond
                                                    ((eof-object? line)
                                                        (close-input-port file)
                                                        (display "Average earnings of all employees less than the threshold: $")
                                                        (display (/ total count))                                                                                                                                                                                      
                                                        (newline)  
                                                        (newline)                                     
                                                    )
